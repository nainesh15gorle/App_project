          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button
                ...
                className="px-8 py-3 bg-[#] text-[#ffffff] rounded-lg hover:bg-yellow-600 transition-all duration-300 font-semibold flex items-center justify-center gap-2 group"
              >
                Browse Inventory
                <ArrowRight
                  size={20}
              ...
              <div className="relative bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-8 border border-white border-opacity-20">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white bg-opacity-10 rounded-xl p-4 backdrop-blur-sm">
                    ...
                    <p className="text-2xl font-bold">Nil</p>
                  ...
                  <div className="col-span-2 bg-white bg-opacity-10 rounded-xl p-4 backdrop-blur-sm">
                    ...
                    <p className="text-sm text-gray-300">
                      Arduino Uno R3 checked out by Team Alpha(Demo purpose).
                    </p>
                  </div>
                </div>
              </div>
